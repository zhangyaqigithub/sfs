		...
		<div class="x_panel">
			...
			<form method="post" action="appInfolist.html">  
			    ...
			    <ul>
					<li>
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input name="softwareName" type="text" class="form-control col-md-7 col-xs-12" value="${appInfos.softwareName}">
							</div>
						</div>
					</li>
					...
					<li><button type="submit"  id="aa" class="btn btn-primary"> 查 &nbsp;&nbsp;&nbsp;&nbsp;询 </button></li>
				</ul>
			</form>
		</div>
	</div>
